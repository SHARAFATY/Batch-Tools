...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFBNdXwyDAE+1EbsQ5+n//NaBq0EYa+8sR4vUyYuMIfQQ4nq1IMJ7hTRTm8Rs
...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJhZkoFLA==
::ZQ05rAF9IBncCkqN+0xwdVsFAlXTXA==
::ZQ05rAF9IAHYFVzEqQICLRddTQqWXA==
::eg0/rx1wNQPfEVWB+kM9LVsJDDaHMGK7CKF8
::fBEirQZwNQPfEVWB+kM9LVsJDDaHMGK7CKF8
::cRolqwZ3JBvQF1fEqQIRaCxdQgCNK3j6BLQI6+C76eOLpw0QQe4rccLP1buCYPQb61GkdJ8pxTpDl95MBRUYZx2+fE8xsX5HpG2AOcSZ8xjoXkDJ5wsHEmtwiHTDzAY6Y9thlMZNsw==
...
::Zh4grVQjdCyDJGyX8VAjFBNdXwyDAES0A5EO4f7+086CsUYJW/IDVYbV34i8Jewa60vwO5M10xo=
::YB416Ek+ZG8=
::
::
...
echo a >> "assets\settings\color.txt"
...
echo                       Time is %time%
echo.
call :TextColor %basecolor% "                  [Reliant ~ QuickSilver]"
echo.
call :TextColor %basecolor2% "__________________________________________________________________"
echo.
echo.
...
if %input%==menubook (
    ...
    start https://github.com/Quicksilver-lab/Reliant
) else if %input%==exit (
    goto shutdown
) else (
    goto failed
...
echo                       Time is %time%
echo.
call :TextColor %basecolor2% "                  [Reliant ~ QuickSilver]"
echo.
call :TextColor %basecolor2% "__________________________________________________________________"
echo.
echo.
