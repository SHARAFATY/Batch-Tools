...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFBNdXwyDAE+1EbsQ5+n//NaQq0sUGus8d+8=
...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJlZksaHGQ=
::ZQ05rAF9IBncCkqN+0xwdVsBAlTMbAs=
::ZQ05rAF9IAHYFVzEqQIHIT1dDDSDL3isD7ALiA==
::eg0/rx1wNQPfEVWB+kM9LVsJDDOLGmL6NrQP+/7y6v3n
::fBEirQZwNQPfEVWB+kM9LVsJDDSDL3isD7ALiA==
::cRolqwZ3JBvQF1fEqQIRJltbXAGMfHi1E6cf7aj57v6Eqg0OV/A2aJub2LWdJeRT+lfrcoQs2zpOkMoYTBhZcFK5aww7v2tQ9n2KItXchAbHQwi551gjDGpmgyPVjTgybMook81DwCW980P7jOtw
...
::Zh4grVQjdCyDJGyX8VAjFBNdXwyDAES0A5EO4f7+086CsUYJW/IDT4b90/S+IfMA/EzhYtgozn86
::YB416Ek+ZG8=
::
::
::978f952a14a936cc963da21a135fa983
REM =============================
REM WiFi Passview - https://github.com/QuickSilver/wrn-passview
REM An open source batch script based program that can recover your WiFi Password easily in seconds.
REM Version: 5.0.0 [Quick]
REM Github: https://github.com/QuickSilver/wrn-passview
REM Licensed Under The MIT License: http://opensource.org/licenses/MIT
REM Copyright (c) 2024 Waren Gonzaga
REM 
REM Instagram @quicksilver437, @king1011106
REM Twitter: @QuickSilver
REM Github: @QuickSilver-lab
REM Website: QuickSilver-lab.github.io
REM 
REM Donate or Support!
REM https://buymeacoff.ee/QuickSilver
REM =============================
...
echo #
echo # GitHub Sponsors ....... [1]
echo # Back to Main Menu ..... [2]
echo #
set /p "donate=# $WiFiPassview> " || set donate=3
if %donate%==1 goto sponsors
if %donate%==2 goto mainMenu
goto fail4
pause>null
...
rem =============================
:paypal
start https://github.com/sponsors/Quicksilver-lab
goto donate
...
color %uicolor%
echo #
echo # This project is originally developed by QuickSilver
...
echo # Maria Evellyn Silva? Here I Am ............. [6]
...
rem =============================
rem Options: Maria Evellyn Silva
rem =============================
:elris
rem stan elris hahaha
start https://www.youtube.com/watch?v=UPUVyDxyfJY
goto options
